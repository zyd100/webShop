 ...
 * </p>
 * <p>
 * Description: 主页控制器 负责监管 主页，商品搜索页，登录注册页(待定)
 * </p>
 * 
 * @author zyd
 *         <p>
...
/**
 * 
*<p>Title: showHomePage</p> 
*<p>Description: 拦截前往主页的请求，并返回主页需要的数据</p> 
　 * @param model 存放数据的地方
 ...
 */
   ...
   * 
  *<p>Title: searchProduct</p> 
  *<p>Description: 搜索页内使用ajax进行操作</p> 
  　 * @param searchText
  　 * @param offset
  　 * @param limit
  　 * @return
