...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=gb2312 COMMENT='评论表';
...
INSERT INTO `order_history` VALUES (13,'dd337ef2d1134475a00e20257515e0fa','',0,'2020-03-28 06:22:05');
...
INSERT INTO `order_info` VALUES (16,'3a50ea39c626f330fb66887bdf1c5e3d','testId',11000,4,NULL,NULL,NULL,NULL,'2020-03-28 03:10:27'),(17,'9e8984babd1684cabc6dda3193c83c5e','testId',0,5,NULL,NULL,NULL,NULL,'2020-03-28 03:14:40'),(23,'dd337ef2d1134475a00e20257515e0fa','testId',21000,0,'','','','','2020-03-28 06:22:05');
...
INSERT INTO `order_item` VALUES (26,'3a50ea39c626f330fb66887bdf1c5e3d','testId',7,'电脑产品',1000,10),(27,'9e8984babd1684cabc6dda3193c83c5e','testId',7,'电脑产品',1000,1),(28,'3a50ea39c626f330fb66887bdf1c5e3d','testId',7,'电脑产品',1000,1),(38,'dd337ef2d1134475a00e20257515e0fa','testId',7,'电脑产品',1000,21),(41,'9e8984babd1684cabc6dda3193c83c5e','testId',7,'电脑产品',1000,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=gb2312 COMMENT='产品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product` VALUES (7,'电脑产品',NULL,1,1000,899,442,NULL,'2020-03-22 08:28:46','2020-03-28 06:22:41','admin',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=gb2312 COMMENT='产品类别表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=gb2312 COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (10,'admin','21232f297a57a5a743894a0e4a801fc3',NULL,NULL,'2020-03-19 06:38:09'),(11,'testId','e10adc3949ba59abbe56e057f20f883e','testnick','1019661738@qq.com','2020-03-19 06:38:43');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=gb2312 COMMENT='用户权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-29 16:27:14
