			...
			<div id="loginDiv" class="animated zoomIn">
				...
				<form name="loginForm" id="loginForm" action="${pageContext.request.contextPath }/admin/login" method="post">
					<div class="form-group">
						...
						<input type="name" class="form-control" maxlength="5" required="true" id="LoginName" name="userName" placeholder="名字">
					</div>
					<div class="form-group">
						<label for="InputPasswordLogin">密码</label>
						<input type="password" class="form-control" maxlength="13" required="true" id="LoginPassword" name="password" placeholder="密码">
					</div>
